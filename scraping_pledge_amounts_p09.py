...
count_pledge=13627
for id_proj, url_proj in zip(data_final["id"][13627:15330], urls_list[13627:15330]):
    ...
    data_pledges.to_csv (r'data_contribuciones_p09.csv', mode = 'a', sep = ',', index = False, header=False)
    count_pledge += 1
    del data_pledges
    del df_pledges
    del pledge_amounts
