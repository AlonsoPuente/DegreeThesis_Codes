...
count_pledge=5111
for id_proj, url_proj in zip(data_final["id"][5111:6815], urls_list[5111:6815]):
    ...
    data_pledges.to_csv (r'data_contribuciones_p04.csv', mode = 'a', sep = ',', index = False, header=False)
    count_pledge += 1
    del data_pledges
    del df_pledges
    del pledge_amounts
