...
count_pledge=3407
for id_proj, url_proj in zip(data_final["id"][3407:5111], urls_list[3407:5111]):
    ...
    data_pledges.to_csv (r'data_contribuciones_p03.csv', mode = 'a', sep = ',', index = False, header=False)
    count_pledge += 1
    del data_pledges
    del df_pledges
    del pledge_amounts
