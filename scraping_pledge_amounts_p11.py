...
count_pledge=17033
for id_proj, url_proj in zip(data_final["id"][17033:18736], urls_list[17033:18736]):
    ...
    data_pledges.to_csv (r'data_contribuciones_p11.csv', mode = 'a', sep = ',', index = False, header=False)
    count_pledge += 1
    del data_pledges
    del df_pledges
    del pledge_amounts
