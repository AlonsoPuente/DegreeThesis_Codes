...
count_pledge=20439
for id_proj, url_proj in zip(data_final["id"][20439:22142], urls_list[20439:22142]):
    ...
    data_pledges.to_csv (r'data_contribuciones_p13.csv', mode = 'a', sep = ',', index = False, header=False)
    count_pledge += 1
    del data_pledges
    del df_pledges
    del pledge_amounts
