...
count_pledge=15330
for id_proj, url_proj in zip(data_final["id"][15330:17033], urls_list[15330:17033]):
    ...
    data_pledges.to_csv (r'data_contribuciones_p10.csv', mode = 'a', sep = ',', index = False, header=False)
    count_pledge += 1
    del data_pledges
    del df_pledges
    del pledge_amounts
