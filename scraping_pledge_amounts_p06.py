...
count_pledge=8518
for id_proj, url_proj in zip(data_final["id"][8518:10221], urls_list[8518:10221]):
    ...
    data_pledges.to_csv (r'data_contribuciones_p06.csv', mode = 'a', sep = ',', index = False, header=False)
    count_pledge += 1
    del data_pledges
    del df_pledges
    del pledge_amounts
