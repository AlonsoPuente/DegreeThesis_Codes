...
count_pledge=1703
for id_proj, url_proj in zip(data_final["id"][1703:3407], urls_list[1703:3407]):
    ...
    data_pledges.to_csv (r'data_contribuciones_p02.csv', mode = 'a', sep = ',', index = False, header=False)
    count_pledge += 1
    del data_pledges
    del df_pledges
    del pledge_amounts
