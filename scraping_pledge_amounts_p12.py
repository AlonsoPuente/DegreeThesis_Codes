...
count_pledge=18736
for id_proj, url_proj in zip(data_final["id"][18736:20439], urls_list[18736:20439]):
    ...
    data_pledges.to_csv (r'data_contribuciones_p12.csv', mode = 'a', sep = ',', index = False, header=False)
    count_pledge += 1
    del data_pledges
    del df_pledges
    del pledge_amounts
