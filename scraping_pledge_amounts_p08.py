...
count_pledge=11924
for id_proj, url_proj in zip(data_final["id"][11924:13627], urls_list[11924:13627]):
    ...
    data_pledges.to_csv (r'data_contribuciones_p08.csv', mode = 'a', sep = ',', index = False, header=False)
    count_pledge += 1
    del data_pledges
    del df_pledges
    del pledge_amounts
